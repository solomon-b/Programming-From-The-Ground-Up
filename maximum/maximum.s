...
# %ecx - An iterator value for my while loop
#
...
_start:
	      ...
	      movl  data_length, %ecx          # Load the list length into ecx

	      movl  $0, %edi                   # Load 0 into the index register
	      movl  data_items(,%edi,4), %eax  # Load the first byte of data
	      movl  %eax, %ebx                 # Since this is the first item. %eax holds the largest value

start_loop:
	      cmpl  $0, %ecx                   # Check if we have hit the end of the list
